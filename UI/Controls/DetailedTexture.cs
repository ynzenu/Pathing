...
namespace BhModule.Community.Pathing.UI.Controls
{
    public class DetailedTexture : IDisposable
    {
        ...
        public AsyncTexture2D Texture { get; set => SetProperty(field, value, v => field = v, () => ApplyBounds(), value is not null); }

        public AsyncTexture2D HoveredTexture { get; set => SetProperty(field, value, v => field = v, () => ApplyBounds(), value is not null); }

        public AsyncTexture2D FallBackTexture { get; set => SetProperty(field, value, v => field = v, () => ApplyBounds(), value is not null); }
